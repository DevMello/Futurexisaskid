package dev.futurex.futurex.gui.window;
...
import dev.futurex.futurex.gui.window.windows.SocialWindow;
...
public class Window implements MixinInterface {
    ...
    public void drawWindowTitle() {
        Render2DUtil.drawRect(x - 2, y, (x + this.width + 2), y + 14, 0, ThemeColor.COLOR, -1, false, Render2DBuilder.Render2DMode.Normal);
    ...
    public static void drawBar() {
        Render2DUtil.drawRect(0, 0, new ScaledResolution(mc).getScaledWidth(), 30, 1, new Color(18, 18, 18, 90).getRGB(), -1, false, Render2DBuilder.Render2DMode.Normal);
    ...
    public static void drawSideBar() {
        ...
        windowOffset = 0;
        Render2DUtil.drawRect((int) (windowOffset), new ScaledResolution(mc).getScaledHeight() - 30, new ScaledResolution(mc).getScaledWidth(), new ScaledResolution(mc).getScaledHeight(), 0, new Color(18, 18, 18, 90).getRGB(), new Color(0, 0, 0, 90).getRGB(), false, Render2DBuilder.Render2DMode.Both);
        for (Window window : windows) {
            ...
            Render2DUtil.drawRect((int) (3 + windowOffset), new ScaledResolution(mc).getScaledHeight() - 30, 3 + windowOffset + FontUtil.getStringWidth(window.name), new ScaledResolution(mc).getScaledHeight(), 1, window.animationManager.getAnimationFactor() > 0.05 ? ThemeColor.COLOR : windowColor, -1, false, Render2DBuilder.Render2DMode.Normal);
