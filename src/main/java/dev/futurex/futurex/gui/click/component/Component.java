...
public class Component implements MixinInterface {
    ...
    public void drawComponent(int x, int y, int height, int width) {
        ...
        if (animationFrameManager.getAnimationFactor() > 0.05) {
            ...
            Render2DUtil.drawRect(x + 4, y + height + (frame.offset * height), (x + width) - 1, (y + height) + height + (frame.offset * height), 0, colorBind, -1, false, Render2DBuilder.Render2DMode.Normal);
