package dev.futurex.futurex.gui.click.component;
...
public class SubComponent implements MixinInterface {
    ...
    public void drawSubComponent(int x, int y, int height, int width) {
        if (setting instanceof Checkbox) {
            ...
            Render2DUtil.drawRect(x, y + height + (preOffset * height), x + width, y + height * 2 + (preOffset * height), 0, 0x99202020, -1, false, Render2DBuilder.Render2DMode.Normal);
            Render2DUtil.drawRect(x + 4, y + height + (preOffset * height), x + width, (y + height) + height + (preOffset * height), 0, color, -1, false, Render2DBuilder.Render2DMode.Normal);
            Render2DUtil.drawRect(x + 4, y + height + (preOffset * height), (x + (animationComponentManager.getAnimationFactor() <= 0.05 ? 4 : 0) + (width * MathUtil.clamp((float) animationComponentManager.getAnimationFactor(), 0, 1))), (y + height) + height + (preOffset * height), 0, ThemeColor.COLOR, -1, false, Render2DBuilder.Render2DMode.Normal);
            ...
            Render2DUtil.drawRect(x, y + height + (preOffset * height), x + width, y + height * 2 + (preOffset * height), 0, 0x99202020, -1, false, Render2DBuilder.Render2DMode.Normal);
            Render2DUtil.drawRect(x + 4, y + height + (preOffset * height), (x + width) - 1, (y + height) + height + (preOffset * height), 0, color, -1, false, Render2DBuilder.Render2DMode.Normal);
            ...
            Render2DUtil.drawRect(x, y + height + (preOffset * height), x + width, y + height * 2 + (preOffset * height), 0, 0x99202020, -1, false, Render2DBuilder.Render2DMode.Normal);
            Render2DUtil.drawRect(x + 4, y + height + (preOffset * height), (x + width) - 1, (y + height) + height + (preOffset * height), 0, color, -1, false, Render2DBuilder.Render2DMode.Normal);
            Render2DUtil.drawRect(x + 4, y + height + (preOffset * height), x + 4 + (rectAdd > width - 1 ? (width - 5) : rectAdd), (y + height) + height + (preOffset * height), 0, ThemeColor.COLOR, -1, false, Render2DBuilder.Render2DMode.Normal);
