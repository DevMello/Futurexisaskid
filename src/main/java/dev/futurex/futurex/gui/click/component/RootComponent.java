...
public class RootComponent implements MixinInterface {
    ...
    public dev.futurex.futurex.gui.click.Frame frame;
    ...
    public void drawRootComponent(int x, int y, int height, int width) {
        if (subsetting instanceof SubCheckbox) {
            ...
            Render2DUtil.drawRect(x + 8, y + height + (frame.offset * height), x + width, (y + height) + height + (frame.offset * height), 0, color, -1, false, Render2DBuilder.Render2DMode.Normal);
            Render2DUtil.drawRect(x + 8, y + height + (frame.offset * height), (x + (animationComponentManager.getAnimationFactor() <= 0.05 ? 8 : 0) + (width * MathUtil.clamp((float) animationComponentManager.getAnimationFactor(), 0, 1))), (y + height) + height + (frame.offset * height), 0, ThemeColor.COLOR, -1, false, Render2DBuilder.Render2DMode.Normal);
        ...
        if (subsetting instanceof SubMode) {
            ...
            Render2DUtil.drawRect(x, y + height + (frame.offset * height), x + width, y + height * 2 + (frame.offset * height), 0, 0x99202020, -1, false, Render2DBuilder.Render2DMode.Normal);
            Render2DUtil.drawRect(x + 8, y + height + (frame.offset * height), (x + width) - 1, (y + height) + height + (frame.offset * height), 0, color, -1, false, Render2DBuilder.Render2DMode.Normal);
        ...
        if (subsetting instanceof SubSlider) {
            ...
            Render2DUtil.drawRect(x, y + height + (frame.offset * height), x + width, y + height * 2 + (frame.offset * height), 0, 0x99202020, -1, false, Render2DBuilder.Render2DMode.Normal);
            Render2DUtil.drawRect(x + 8, y + height + (frame.offset * height), (x + width) - 1, (y + height) + height + (frame.offset * height), 0, color, -1, false, Render2DBuilder.Render2DMode.Normal);
            Render2DUtil.drawRect(x + 8, y + height + (frame.offset * height), x + 8 + (rectAdd > width ? (width - 8) : rectAdd), (y + height) + height + (frame.offset * height), 0, ThemeColor.COLOR, -1, false, Render2DBuilder.Render2DMode.Normal);
